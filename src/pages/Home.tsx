...
export const Home: React.FC<HomeProps> = ({ onSelectAddon }) => {
  ...
  return (
    <div className="space-y-4 pb-20">
      {/* Header passing activeCategory props */}
      <Header activeCategory={activeCategory} setActiveCategory={setActiveCategory} />

      {/* Sliding & Swipable Carousel - Responsive Heights & Width */}
      {filteredAddons.length > 0 && (
        ...
        >
          <div
            ...
            className="relative w-full aspect-[16/9] sm:aspect-[21/9] max-w-4xl mx-auto rounded-2xl overflow-hidden border border-zinc-800 shadow-xl bg-zinc-900 touch-pan-y"
          >
            <div
            ...
            >
              {filteredAddons.map((item) => (
                ...
                >
                  ...
                  />
                  <div className="absolute inset-x-0 bottom-0 p-4 sm:p-6 bg-gradient-to-t from-black via-black/60 to-transparent flex flex-col justify-end items-start space-y-1">
                    <span className="px-2 py-0.5 rounded text-[9px] sm:text-[10px] font-black tracking-wider uppercase bg-sky-500 text-slate-950">
                      {item.category}
                    </span>
      ...
      {/* Auto-sizing Responsive Grid: 2 cols on mobile, 3 on tablet, 4 on desktop */}
