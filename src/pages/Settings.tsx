...
import { Settings as SettingsIcon, Trash2, Info, Globe, Mail, Check } from 'lucide-react';
      ...
      <div className="space-y-3">
          ...
          <div className="grid grid-cols-3 gap-2 pt-1">
            {languages.map((lang) => (
              ...
              >
                ...
                {selectedLang === lang.code && <Check className="w-3 h-3 text-sky-400 ml-1 flex-shrink-0" />}
              </button>
            ))}
          </div>
        </div>
        ...
        <div className="bg-zinc-900/90 border border-zinc-800 rounded-2xl p-4 flex items-center justify-between">
          ...
          <button
            ...
            className="flex items-center space-x-1.5 px-3 py-1.5 rounded-xl bg-red-500/10 text-red-400 border border-red-500/20 text-xs font-bold hover:bg-red-500/20 disabled:opacity-40 disabled:pointer-events-none"
          >
